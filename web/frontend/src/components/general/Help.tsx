...
import {IoIosBody, IoIosPersonAdd, IoMdAddCircleOutline, IoMdFingerPrint, IoMdSad, IoMdTrash} from "react-icons/io";
            ...
            <section>
              ...
              <div className="row">
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="far fa-paper-plane text-primary pe-2"/> Can you delete a user?<IoMdTrash/></h6>
                  <p>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="fas fa-pen-alt text-primary pe-2"/> How do I register?<IoIosPersonAdd/></h6>
                  <p>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="fas fa-user text-primary pe-2"/> How do I add a device?<IoMdAddCircleOutline/></h6>
                  <p>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="bi bi-envelope"/> I registered but still cant log in.<IoMdSad/></h6>
                  <p>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="fas fa-home text-primary pe-2"/> Where can I find my One-Time Password?<IoMdFingerPrint/></h6>
                ...
                <div className="col-md-6 col-lg-4 mb-4">
                  <h6 className="mb-3 text-primary"><i className="fas fa-book-open text-primary pe-2"/> Can I have more than one person registered to a <IoIosBody/> device?</h6>
                  <p>
